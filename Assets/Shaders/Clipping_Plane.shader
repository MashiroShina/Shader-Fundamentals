Shader "Custom/Clipping_Plane" {
    ...
    SubShader{
        ...
        void surf (Input i, inout SurfaceOutputStandard o) {
            ...
            float distance = dot(i.worldPos, _Plane.xyz);//当前顶点坐标*plane法向量，但是这里没有算相对偏移差
            distance += _Plane.w;//w是原点到可视平面中心距离
            ...
            o.Emission = lerp(_CutoffColor, _Emission, facing);//-1是黑0是正常 1为白
        }
        ENDCG
    }
    FallBack "Standard" //
